...
public class StaffRepository {
	...
	public int addStaff(String name, String staffId, int rank, String contact) {
		...
		String message = "You have been granted access to the IIR Welfare Platform on http://www.iirwelfare.com. Your username is "+staffId+" and your password is "+code+" Thank you";
